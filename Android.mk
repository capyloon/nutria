...
$(LOCAL_INSTALLED_MODULE): $(LOCAL_BUILT_MODULE)
	...
	@cp $(GAIA_PATH)/scripts/common.js $(B2G_DEFAULTS)/pref/common.js
	@cp $(GAIA_PATH)/scripts/teracube.js $(B2G_DEFAULTS)/pref/teracube.js
	# Copy the default settings
	@cp $(GAIA_PATH)/scripts/default-settings.json $(B2G_DEFAULTS)/settings.json
...
$(LOCAL_BUILT_MODULE):
	...
	(cd $(GAIA_PATH)/builder ; \
	 CAPYLOON_APPS=$(abspath $(GAIA_PATH)/apps) \
