...
__exports.evaluateFendWithTimeoutMultiple = function(inputs, timeout) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        const ptr0 = passStringToWasm0(inputs, wasm.__wbindgen_export_0, wasm.__wbindgen_export_1);
        const len0 = WASM_VECTOR_LEN;
...
__exports.evaluateFendWithVariablesJson = function(input, timeout, variables) {
    try {
        ...
        const ptr0 = passStringToWasm0(input, wasm.__wbindgen_export_0, wasm.__wbindgen_export_1);
        const len0 = WASM_VECTOR_LEN;
        const ptr1 = passStringToWasm0(variables, wasm.__wbindgen_export_0, wasm.__wbindgen_export_1);
...
fend_wasm = Object.assign(init, { initSync }, __exports);
