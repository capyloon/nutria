import{a as c}from"./chunk.33EZUAQI.js";import{a,b}from"./chunk.52TP6P7G.js";import{a as i}from"./chunk.2XQLLZV4.js";import{a as f}from"./chunk.PC5WGFOA.js";import{a as l}from"./chunk.V4OMSSO6.js";import{a as o,b as r,c as h,d as u}from"./chunk.GVR6SJVE.js";import{h as n}from"./chunk.7EIHAL55.js";import{g as s}from"./chunk.OAQCUA7X.js";var e=class extends n{constructor(){super(...arguments);this.hasFocus=!1;this.label="";this.disabled=!1}click(){this.button.click()}focus(t){this.button.focus(t)}blur(){this.button.blur()}handleBlur(){this.hasFocus=!1,l(this,"sl-blur")}handleFocus(){this.hasFocus=!0,l(this,"sl-focus")}handleClick(t){this.disabled&&(t.preventDefault(),t.stopPropagation())}render(){let t=!!this.href,d=t?a`a`:a`button`;return b`
      <${d}
        part="base"
