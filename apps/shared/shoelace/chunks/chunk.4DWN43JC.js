import{a as $}from"./chunk.FQ5EK26S.js";import{a as g}from"./chunk.R5UEL6LD.js";import{a as v}from"./chunk.FOJ445RA.js";import{h as y}from"./chunk.RLLTRZYL.js";import{a as b}from"./chunk.RHW2XED2.js";import{a as d}from"./chunk.PC5WGFOA.js";import{a as c}from"./chunk.OSEV3RCT.js";import{a as r}from"./chunk.V4OMSSO6.js";import{a as l}from"./chunk.2XQLLZV4.js";import{a as m,b as i,c as u,d as f}from"./chunk.GVR6SJVE.js";import{c as n,h as p}from"./chunk.7EIHAL55.js";import{g as t}from"./chunk.OAQCUA7X.js";var e=class extends p{constructor(){super(...arguments);this.formSubmitController=new v(this);this.hasSlotController=new b(this,"help-text","label");this.localize=new y(this);this.hasFocus=!1;this.isPasswordVisible=!1;this.type="text";this.size="medium";this.value="";this.filled=!1;this.pill=!1;this.label="";this.helpText="";this.clearable=!1;this.togglePassword=!1;this.disabled=!1;this.readonly=!1;this.required=!1;this.invalid=!1}get valueAsDate(){var s,a;return(a=(s=this.input)==null?void 0:s.valueAsDate)!=null?a:null}set valueAsDate(s){this.input.valueAsDate=s,this.value=this.input.value}get valueAsNumber(){var s,a;return(a=(s=this.input)==null?void 0:s.valueAsNumber)!=null?a:parseFloat(this.value)}set valueAsNumber(s){this.input.valueAsNumber=s,this.value=this.input.value}firstUpdated(){this.invalid=!this.input.checkValidity()}focus(s){this.input.focus(s)}blur(){this.input.blur()}select(){this.input.select()}setSelectionRange(s,a,o="none"){this.input.setSelectionRange(s,a,o)}setRangeText(s,a,o,h="preserve"){this.input.setRangeText(s,a,o,h),this.value!==this.input.value&&(this.value=this.input.value,r(this,"sl-input"),r(this,"sl-change"))}reportValidity(){return this.input.reportValidity()}setCustomValidity(s){this.input.setCustomValidity(s),this.invalid=!this.input.checkValidity()}handleBlur(){this.hasFocus=!1,r(this,"sl-blur")}handleChange(){this.value=this.input.value,r(this,"sl-change")}handleClearClick(s){this.value="",r(this,"sl-clear"),r(this,"sl-input"),r(this,"sl-change"),this.input.focus(),s.stopPropagation()}handleDisabledChange(){this.input.disabled=this.disabled,this.invalid=!this.input.checkValidity()}handleFocus(){this.hasFocus=!0,r(this,"sl-focus")}handleInput(){this.value=this.input.value,r(this,"sl-input")}handleInvalid(){this.invalid=!0}handleKeyDown(s){let a=s.metaKey||s.ctrlKey||s.shiftKey||s.altKey;s.key==="Enter"&&!a&&setTimeout(()=>{s.defaultPrevented||this.formSubmitController.submit()})}handlePasswordToggle(){this.isPasswordVisible=!this.isPasswordVisible}handleValueChange(){this.invalid=!this.input.checkValidity()}render(){let s=this.hasSlotController.test("label"),a=this.hasSlotController.test("help-text"),o=this.label?!0:!!s,h=this.helpText?!0:!!a,x=this.clearable&&!this.disabled&&!this.readonly&&this.value.length>0;return n`
      ...
      >
        ...
        <div part="form-control-input" class="form-control-input">
          <div
            part="base"
            class=${d({input:!0,"input--small":this.size==="small","input--medium":this.size==="medium","input--large":this.size==="large","input--pill":this.pill,"input--standard":!this.filled,"input--filled":this.filled,"input--disabled":this.disabled,"input--focused":this.hasFocus,"input--empty":!this.value,"input--invalid":this.invalid})}
          >
