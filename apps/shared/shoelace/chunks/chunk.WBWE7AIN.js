import{a as C}from"./chunk.4CLSN6UG.js";import{a as u,b as y}from"./chunk.PYPBGY2O.js";import{a as T}from"./chunk.7UUTNQZG.js";import{a as l,c as d}from"./chunk.F64FS4SB.js";import{a as r,c as n}from"./chunk.O7L2VUC4.js";import{h as _}from"./chunk.RLLTRZYL.js";import{a as w}from"./chunk.RHW2XED2.js";import{a as b}from"./chunk.PC5WGFOA.js";import{a as k}from"./chunk.OSEV3RCT.js";import{a,b as f}from"./chunk.V4OMSSO6.js";import{a as m}from"./chunk.2XQLLZV4.js";import{a as v,b as c,d as h}from"./chunk.GVR6SJVE.js";import{c as p,h as g}from"./chunk.7EIHAL55.js";import{g as i}from"./chunk.OAQCUA7X.js";var t=class extends g{constructor(){super(...arguments);this.hasSlotController=new w(this,"footer");this.localize=new _(this);this.open=!1;this.label="";this.noHeader=!1}connectedCallback(){super.connectedCallback(),this.modal=new C(this)}firstUpdated(){this.dialog.hidden=!this.open,this.open&&(this.modal.activate(),u(this))}disconnectedCallback(){super.disconnectedCallback(),y(this)}async show(){if(!this.open)return this.open=!0,f(this,"sl-after-show")}async hide(){if(!!this.open)return this.open=!1,f(this,"sl-after-hide")}requestClose(e){if(a(this,"sl-request-close",{cancelable:!0,detail:{source:e}}).defaultPrevented){let o=n(this,"dialog.denyClose",{dir:this.localize.dir()});l(this.panel,o.keyframes,o.options);return}this.hide()}handleKeyDown(e){e.key==="Escape"&&(e.stopPropagation(),this.requestClose("keyboard"))}async handleOpenChange(){if(this.open){a(this,"sl-show"),this.originalTrigger=document.activeElement,this.modal.activate(),u(this);let e=this.querySelector("[autofocus]");e&&e.removeAttribute("autofocus"),await Promise.all([d(this.dialog),d(this.overlay)]),this.dialog.hidden=!1,requestAnimationFrame(()=>{a(this,"sl-initial-focus",{cancelable:!0}).defaultPrevented||(e?e.focus({preventScroll:!0}):this.panel.focus({preventScroll:!0})),e&&e.setAttribute("autofocus","")});let s=n(this,"dialog.show",{dir:this.localize.dir()}),o=n(this,"dialog.overlay.show",{dir:this.localize.dir()});await Promise.all([l(this.panel,s.keyframes,s.options),l(this.overlay,o.keyframes,o.options)]),a(this,"sl-after-show")}else{a(this,"sl-hide"),this.modal.deactivate(),await Promise.all([d(this.dialog),d(this.overlay)]);let e=n(this,"dialog.hide",{dir:this.localize.dir()}),s=n(this,"dialog.overlay.hide",{dir:this.localize.dir()});await Promise.all([l(this.panel,e.keyframes,e.options),l(this.overlay,s.keyframes,s.options)]),this.dialog.hidden=!0,y(this);let o=this.originalTrigger;typeof(o==null?void 0:o.focus)=="function"&&setTimeout(()=>o.focus()),a(this,"sl-after-hide")}}render(){return p`
    ...
    `}};t.styles=T,i([h(".dialog")],t.prototype,"dialog",2),i([h(".dialog__panel")],t.prototype,"panel",2),i([h(".dialog__overlay")],t.prototype,"overlay",2),i([c({type:Boolean,reflect:!0})],t.prototype,"open",2),i([c({reflect:!0})],t.prototype,"label",2),i([c({attribute:"no-header",type:Boolean,reflect:!0})],t.prototype,"noHeader",2),i([k("open",{waitUntilFirstUpdate:!0})],t.prototype,"handleOpenChange",1),t=i([v("sl-dialog")],t);r("dialog.show",{keyframes:[{opacity:0,transform:"scale(0.8)"},{opacity:1,transform:"scale(1)"}],options:{duration:250,easing:"ease"}});r("dialog.hide",{keyframes:[{opacity:1,transform:"scale(1)"},{opacity:0,transform:"scale(0.8)"}],options:{duration:250,easing:"ease"}});r("dialog.denyClose",{keyframes:[{transform:"scale(1)"},{transform:"scale(1.02)"},{transform:"scale(1)"}],options:{duration:250}});r("dialog.overlay.show",{keyframes:[{opacity:0},{opacity:1}],options:{duration:250}});r("dialog.overlay.hide",{keyframes:[{opacity:1},{opacity:0}],options:{duration:250}});export{t as a};
