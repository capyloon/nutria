            ...
            >
              ...
              ${this.multiple?u`
                    <div part="tags" class="select__tags">
                      ${this.selectedOptions.map((r,b)=>b<this.maxOptionsVisible||this.maxOptionsVisible<=0?u`
                            <sl-tag
                              part="tag"
                              ?pill=${this.pill}
                              size=${this.size}
                              removable
                              @sl-remove=${I=>this.handleTagRemove(I,r)}
                            >
                              ${r.getTextLabel()}
                            </sl-tag>
                          `:b===this.maxOptionsVisible?u` <sl-tag size=${this.size}> +${this.selectedOptions.length-b} </sl-tag> `:null)}
                    </div>
                  `:""}
