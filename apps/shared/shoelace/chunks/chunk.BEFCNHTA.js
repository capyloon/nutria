...
var i2 = async (t3, e4, n3) => {
  const { placement: o4 = "bottom", strategy: i4 = "absolute", middleware: a3 = [], platform: l3 } = n3, s3 = a3.filter(Boolean), c3 = await (null == l3.isRTL ? void 0 : l3.isRTL(e4));
  let f3 = await l3.getElementRects({ reference: t3, floating: e4, strategy: i4 }), { x: u3, y: m3 } = r(f3, o4, c3), g3 = o4, d3 = {}, p3 = 0;
  for (let n4 = 0; n4 < s3.length; n4++) {
    const { name: a4, fn: h3 } = s3[n4], { x: y4, y: x3, data: w3, reset: v3 } = await h3({ x: u3, y: m3, initialPlacement: o4, placement: g3, strategy: i4, middlewareData: d3, rects: f3, platform: l3, elements: { reference: t3, floating: e4 } });
...
async function s(t3, e4) {
  var n3;
  void 0 === e4 && (e4 = {});
  const { x: o4, y: r3, platform: i4, rects: s3, elements: c3, strategy: f3 } = t3, { boundary: u3 = "clippingAncestors", rootBoundary: m3 = "viewport", elementContext: g3 = "floating", altBoundary: d3 = false, padding: p3 = 0 } = e4, h3 = a(p3), y4 = c3[d3 ? "floating" === g3 ? "reference" : "floating" : g3], x3 = l(await i4.getClippingRect({ element: null == (n3 = await (null == i4.isElement ? void 0 : i4.isElement(y4))) || n3 ? y4 : y4.contextElement || await (null == i4.getDocumentElement ? void 0 : i4.getDocumentElement(c3.floating)), boundary: u3, rootBoundary: m3, strategy: f3 })), w3 = "floating" === g3 ? __spreadProps(__spreadValues({}, s3.floating), { x: o4, y: r3 }) : s3.reference, v3 = await (null == i4.getOffsetParent ? void 0 : i4.getOffsetParent(c3.floating)), b3 = await (null == i4.isElement ? void 0 : i4.isElement(v3)) && await (null == i4.getScale ? void 0 : i4.getScale(v3)) || { x: 1, y: 1 }, R2 = l(i4.convertOffsetParentRelativeRectToViewportRelativeRect ? await i4.convertOffsetParentRelativeRectToViewportRelativeRect({ rect: w3, offsetParent: v3, strategy: f3 }) : w3);
...
var m = (n3) => ({ name: "arrow", options: n3, async fn(r3) {
  ...
  const T3 = b3 / 2 - R2 / 2, O3 = d3[w3], D3 = P3 - x3[y4] - d3[v3], E3 = P3 / 2 - x3[y4] / 2 + T3, L3 = u(O3, E3, D3), k2 = null != t2(f3) && E3 != L3 && m3.reference[y4] / 2 - (E3 < O3 ? d3[w3] : d3[v3]) - x3[y4] / 2 < 0;
...
function y2(n3, r3, i4) {
  void 0 === i4 && (i4 = false);
  const a3 = t2(n3), l3 = o2(n3), s3 = e3(l3);
...
var b = function(e4) {
  return void 0 === e4 && (e4 = {}), { name: "flip", options: e4, async fn(o4) {
    ...
    d3 || "none" === x3 || T3.push(...function(e5, o5, r4, i5) {
      const a4 = t2(e5);
...
var O = function(e4) {
  return void 0 === e4 && (e4 = 0), { name: "offset", options: e4, async fn(r3) {
    const { x: i4, y: a3 } = r3, l3 = await async function(e5, r4) {
      const { placement: i5, platform: a4, elements: l4 } = e5, s3 = await (null == a4.isRTL ? void 0 : a4.isRTL(l4.floating)), c3 = n(i5), f3 = t2(i5), u3 = "x" === o2(i5), m3 = ["left", "top"].includes(c3) ? -1 : 1, g3 = s3 && u3 ? -1 : 1, d3 = "function" == typeof r4 ? r4(e5) : r4;
...
var E = function(t3) {
  return void 0 === t3 && (t3 = {}), { name: "shift", options: t3, async fn(e4) {
    const { x: r3, y: i4, placement: a3 } = e4, _a = t3, { mainAxis: l3 = true, crossAxis: c3 = false, limiter: f3 = { fn: (t4) => {
      let { x: e5, y: n3 } = t4;
      return { x: e5, y: n3 };
    } } } = _a, m3 = __objRest(_a, ["mainAxis", "crossAxis", "limiter"]), g3 = { x: r3, y: i4 }, d3 = await s(e4, m3), p3 = o2(n(a3)), h3 = D(p3);
...
var k = function(e4) {
  return void 0 === e4 && (e4 = {}), { name: "size", options: e4, async fn(r3) {
    const { placement: i4, rects: a3, platform: l3, elements: u3 } = r3, _a = e4, { apply: m3 = () => {
    } } = _a, g3 = __objRest(_a, ["apply"]), d3 = await s(r3, g3), p3 = n(i4), h3 = t2(i4), y4 = "x" === o2(i4), { width: x3, height: w3 } = a3.floating;
    let v3, b3;
    ...
    let P3 = R2, T3 = A2;
    if (y4 ? T3 = c(x3 - d3.right - d3.left, A2) : P3 = c(w3 - d3.bottom - d3.top, R2), !r3.middlewareData.shift && !h3) {
      const t3 = f(d3.left, 0), e5 = f(d3.right, 0), n3 = f(d3.top, 0), o4 = f(d3.bottom, 0);
      y4 ? T3 = x3 - 2 * (0 !== t3 || 0 !== e5 ? t3 + e5 : f(d3.left, d3.right)) : P3 = w3 - 2 * (0 !== n3 || 0 !== o4 ? n3 + o4 : f(d3.top, d3.bottom));
    }
...
function g2(t3) {
  const { overflow: e4, overflowX: n3, overflowY: i4, display: r3 } = o3(t3);
...
function E2(t3, e4, o4, i4) {
  ...
  if (s3) {
    ...
    for (; o5 && i4 && e5 !== t4; ) {
      const t5 = L2(o5), e6 = o5.getBoundingClientRect(), i5 = getComputedStyle(o5);
      e6.x += (o5.clientLeft + parseFloat(i5.paddingLeft)) * t5.x, e6.y += (o5.clientTop + parseFloat(i5.paddingTop)) * t5.y, h3 *= t5.x, p3 *= t5.y, g3 *= t5.x, m3 *= t5.y, h3 += e6.x, p3 += e6.y, o5 = n2(o5).frameElement;
    }
  }
  ...
  if ("viewport" === i4)
    c3 = function(t3, e5) {
      ...
      if (r3) {
        ...
        const t4 = x2();
        (!t4 || t4 && "fixed" === e5) && (s4 = r3.offsetLeft, f4 = r3.offsetTop);
      }
    ...
    c3 = function(t3, e5) {
      const n3 = E2(t3, true, "fixed" === e5), o4 = n3.top + t3.clientTop, i5 = n3.left + t3.clientLeft, r3 = a2(t3) ? L2(t3) : { x: 1, y: 1 };
...
function H(t3, e4) {
  ...
  for (; r3 && m2(r3) && "static" === o3(r3).position; )
    r3 = A(r3, e4);
  return r3 && ("html" === s2(r3) || "body" === s2(r3) && "static" === o3(r3).position && !y3(r3)) ? i4 : r3 || function(t4) {
    let e5 = F(t4);
    for (; a2(e5) && !w2(e5); ) {
      if (y3(e5))
        return e5;
...
function V(t3, e4, n3) {
  const o4 = a2(e4), i4 = R(e4), r3 = E2(t3, true, "fixed" === n3, e4);
...
var O2 = { getClippingRect: function(t3) {
  ...
  const f3 = "clippingAncestors" === n3 ? function(t4, e5) {
    ...
    for (; d2(c4) && !w2(c4); ) {
      ...
      "fixed" === t5.position ? r3 = null : (l4 ? e6 || r3 : e6 || "static" !== t5.position || !r3 || !["absolute", "fixed"].includes(r3.position)) ? r3 = t5 : i4 = i4.filter((t6) => t6 !== c4), c4 = F(c4);
    }
  ...
  let { rect: e4, offsetParent: n3, strategy: o4 } = t3;
  ...
  let { reference: e4, floating: n3, strategy: o4 } = t3;
...
function P2(t3, e4, n3, o4) {
  void 0 === o4 && (o4 = {});
  const { ancestorScroll: i4 = true, ancestorResize: r3 = true, elementResize: l3 = true, animationFrame: c3 = false } = o4, s3 = i4 && !c3, f3 = s3 || r3 ? [...d2(t3) ? D2(t3) : t3.contextElement ? D2(t3.contextElement) : [], ...D2(e4)] : [];
  f3.forEach((t4) => {
...
function isVirtualElement(e4) {
  return e4 !== null && typeof e4 === "object" && "getBoundingClientRect" in e4;
}
